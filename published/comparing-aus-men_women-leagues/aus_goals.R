...
aus_f_m <- readRDS(here::here("published", "comparing-aus-men_women-leagues", "aus_men_and_women_2019-21.rds"))
...
gt::gtsave(final_table, here::here("published", "comparing-aus-men_women-leagues", "aus_men_and_women_2019-21.html"))
